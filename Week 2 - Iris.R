...
> ?ifeslse
No documentation for ‘ifeslse’ in specified packages and libraries:
you could try ‘??ifeslse’
> ?ifelse
> Versicolor_Is_The_Best = ifelse(iris$pecies == "versicolor", 100, 0)
...
Error: unexpected '>' in ">"
> +   value=value+width
Error in +value = value + width : could not find function "+<-"
> +   count=count+1
Error in +count = count + 1 : could not find function "+<-"
> +   if (value > 100) {
+ +     break
+ +     } 
Error: unexpected '}' in:
...
for (width in sw) {"
>  for (width in sw) {}
Error: unexpected invalid token in " for (width in sw) {"
>  for (width in sw) {
Error: unexpected invalid token in " for (width in sw) {"
>   value = value + width
>   count = count + 1
